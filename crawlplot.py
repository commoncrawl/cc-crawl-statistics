...
PLOTLIB: PlotLibType = os.environ.get('PLOTLIB', 'rpy2.ggplot2')
...
os.makedirs(os.path.join(PLOTDIR, "crawler"), exist_ok=True)
os.makedirs(os.path.join(PLOTDIR, "crawloverlap"), exist_ok=True)
...
class CrawlPlot:
    ...
    def line_plot(self, data, title, ylabel, img_file,
        ...
        if PLOTLIB == 'ggplot':
            ...
            fig, ax = plt.subplots(figsize=(DEFAULT_FIGSIZE, DEFAULT_FIGSIZE * ratio))
            ...
            legend = ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.05), ncol=4,
            ...
            plt.savefig(img_path, dpi=DEFAULT_DPI, bbox_inches=None, facecolor='white')
            plt.close()
